        ...
        <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-bifrost-accent to-cyan-500 flex items-center justify-center shadow-lg" aria-hidden="true">
              <svg className="w-6 h-6 text-bifrost-on-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <div>
              <h1 className="text-lg font-bold tracking-tight text-bifrost-heading sm:text-xl">Bifrost Client</h1>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <div className={`badge mr-1 ${isConnected ? 'badge-success' : 'badge-error'}`} role="status">
              <span className={`w-2 h-2 rounded-full mr-2 ${isConnected ? 'bg-bifrost-success' : 'bg-bifrost-error'}`} aria-hidden="true" />
