---
title: "Getting Started with Bifrost"
description: "Documentation for Getting Started with Bifrost"
---
...
- [Configuration Guide](configuration.mdx) - Full configuration reference
- [Backend Guide](backends.mdx) - Configure WireGuard, OpenVPN, and proxy backends
- [Authentication Guide](authentication.mdx) - Set up authentication
- [API Reference](api/index.mdx) - REST API documentation
